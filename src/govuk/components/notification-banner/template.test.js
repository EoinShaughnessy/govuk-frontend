...
describe('Notification-banner', () => {
  ...
  describe('html', () => {
    ...
    it('renders content as html', () => {
      ...
      expect($contentHtml.html().trim()).toEqual('<h3 class="govuk-heading-m">This publication was withdrawn on 7 March 2014</h3><p class="govuk-notification-banner__heading">Archived and replaced by the <a href="#" class="govuk-notification-banner__link">new planning guidance</a> launched 6 March 2014 on an external website</p>')
    })
  })
